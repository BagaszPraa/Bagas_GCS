...
Item {
    ...
    readonly property string armTitle:                      qsTr("Arming")
    readonly property string forceArmTitle:                 qsTr("Paksa Arming")
    ...
    readonly property string armMessage:                        qsTr("Arming Drone.")
    readonly property string forceArmMessage:                   qsTr("Peringatan: Ini akan memaksa Arming Drone dengan melewati pemeriksaan keselamatan (Safety Check).")
    readonly property string disarmMessage:                     qsTr("Disarm Drone")
    readonly property string emergencyStopMessage:              qsTr("PERINGATAN: Ini akan menghentikan semua motor. Hal ini menyebabkan Drone jatuh apabila masih di udara")
    readonly property string takeoffMessage:                    qsTr("Lepas landas (Takeoff) dari tanah dan tahan posisi sesuai dengan ketinggian yang di-set.")
    readonly property string gripperMessage:                    qsTr("Ambil atau lepaskan kargo (Gripper)")
    readonly property string startMissionMessage:               qsTr("Lepas landas (Takeoff) dari tanah dan mulai misi saat ini.")
    ...
    readonly property string landMessage:                       qsTr("Mendaratkan Drone di posisi saat ini.")
    readonly property string rtlMessage:                        qsTr("Kembali ke posisi peluncuran Drone.")
    readonly property string changeAltMessage:                  qsTr("Ubah ketinggian Drone naik atau turun. ")
    readonly property string changeCruiseSpeedMessage:          qsTr("Ubah kecepatan terbang (Cruise Speed).")
    readonly property string changeAirspeedMessage:             qsTr("Ubah setpoint kecepatan udara (Airspeed) yang setara")
    readonly property string gotoMessage:                       qsTr("Pindahkan Drone ke lokasi yang ditentukan.")
             property string setWaypointMessage:                qsTr("Sesuaikan titik arah saat ini %1.").arg(_actionData)
    readonly property string orbitMessage:                      qsTr("Orbit Drone di sekitar lokasi yang ditentukan.")
    readonly property string landAbortMessage:                  qsTr("Batalkan Landing.")
    readonly property string pauseMessage:                      qsTr("Jeda Drone pada posisi saat ini, menyesuaikan ketinggian naik atau turun sesuai kebutuhan.")
    readonly property string mvPauseMessage:                    qsTr("Jeda semua Drone di posisinya saat ini.")
    readonly property string vtolTransitionFwdMessage:          qsTr("Transisi VTOL ke Penerbangan Fixed-Wing.")
    readonly property string vtolTransitionMRMessage:           qsTr("Transisi VTOL ke penerbangan Multi-Rotor.")
    readonly property string roiMessage:                        qsTr("Setel lokasi yang ditentukan sebagai area hadap.")
    readonly property string setHomeMessage:                    qsTr("Setel lokasi sebagai HOME. Ini akan mempengaruhi posisi pulang")
